...
func init() {
	...
	registerMeta("user create", commandMeta{Examples: []string{"p202 user create --user_name admin --user_email admin@example.com --json"}, OutputFields: userFields, Related: []string{"user list", "user role assign"}, Mutating: true})
	registerMeta("user update", commandMeta{Examples: []string{"p202 user update 1 --user_email new@example.com --json"}, OutputFields: userFields, Related: []string{"user get"}, Mutating: true})
	registerMeta("user delete", commandMeta{Examples: []string{"p202 user delete 1 --force"}, Related: []string{"user list"}, Mutating: true})
	...
	registerMeta("user role assign", commandMeta{Examples: []string{"p202 user role assign 1 --role_id 2 --json"}, Related: []string{"user role list", "user role remove"}, Mutating: true})
	registerMeta("user role remove", commandMeta{Examples: []string{"p202 user role remove 1 2 --force"}, Related: []string{"user role list", "user role assign"}, Mutating: true})
	...
	registerMeta("user apikey create", commandMeta{Examples: []string{"p202 user apikey create 1 --json"}, OutputFields: []string{"api_key"}, Related: []string{"user apikey list", "user apikey rotate"}, Mutating: true})
	registerMeta("user apikey delete", commandMeta{Examples: []string{"p202 user apikey delete 1 abc123 --force"}, Related: []string{"user apikey list"}, Mutating: true})
	registerMeta("user apikey rotate", commandMeta{Examples: []string{"p202 user apikey rotate 1 OLD_KEY --force --update-config --json"}, OutputFields: []string{"new_api_key", "old_key_deleted", "config_updated"}, Related: []string{"user apikey list", "user apikey create"}, Mutating: true})
	...
	registerMeta("user prefs update", commandMeta{Examples: []string{"p202 user prefs update 1 --user_account_currency USD --json"}, OutputFields: []string{"user_tracking_domain", "user_account_currency"}, Related: []string{"user prefs get"}, Mutating: true})
}
