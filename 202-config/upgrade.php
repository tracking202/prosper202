...
if ($success != true) {
	...
	You are upgrading from version <?php echoPROSPER202::mysql_version(); ?> to <?php echo$version; ?>.  To continue with the upgrade press the button below to begin the update process.  Please do not click the button twice.  This could take a while depending on the last time you updated your software. 
