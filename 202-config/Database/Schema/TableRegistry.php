...
final class TableRegistry
{
    ...
    public const string TRACKING_CX = '202_tracking_cx';
    public const string CLICKS_TRACKING_CX = '202_clicks_tracking_cx';
    public const string MIGRATION_STATE = '202_migration_state';
