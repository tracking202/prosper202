			...
			<td>
				...
				<div class="skyline">
					...
					<div style="float: left; ">
						...
						&middot;
						<a href="http://www.conversion202.com" <?php if ($navigation[1] == 'alerts202') { echo 'class="bold";'; } ?> target="_blank">Conversion202</a>   
						&middot;						
						...
						&middot;
						<a href="/alerts202/" <?php if ($navigation[1] == 'alerts202') { echo 'class="bold";'; } ?>>Alerts202eh</a>   
						&middot; */ ?> 
						<a href="/202-resources/" <?php if ($navigation[1] == '202-resources') { echo 'class="bold";'; } ?>>Featured Resources<span id="new_offers"></span></a>
