	...
	if ($memcacheWorking) {
		...
		if ($getUrl) {
			...
			if (isset($_GET['c1']) && $_GET['c1'] != '') {
				$new_url = str_replace("[[c1]]", urlencode((string)$_GET['c1']), $new_url);
			} else {
			...
			if (isset($_GET['c2']) && $_GET['c2'] != '') {
				$new_url = str_replace("[[c2]]", urlencode((string)$_GET['c2']), $new_url);
			} else {
			...
			if (isset($_GET['c3']) && $_GET['c3'] != '') {
				$new_url = str_replace("[[c3]]", urlencode((string)$_GET['c3']), $new_url);
			} else {
			...
			if (isset($_GET['c4']) && $_GET['c4'] != '') {
				$new_url = str_replace("[[c4]]", urlencode((string)$_GET['c4']), $new_url);
			} else {
			...
			if (isset($_GET['gclid']) && $_GET['gclid'] != '') {
				$new_url = str_replace("[[gclid]]", urlencode((string)$_GET['gclid']), $new_url);
			} else {
			...
			if (isset($_GET['utm_source']) && $_GET['utm_source'] != '') {
				$new_url = str_replace("[[utm_source]]", urlencode((string)$_GET['utm_source']), $new_url);
			} else {
			...
			if (isset($_GET['utm_medium']) && $_GET['utm_medium'] != '') {
				$new_url = str_replace("[[utm_medium]]", urlencode((string)$_GET['utm_medium']), $new_url);
			} else {
			...
			if (isset($_GET['utm_campaign']) && $_GET['utm_campaign'] != '') {
				$new_url = str_replace("[[utm_campaign]]", urlencode((string)$_GET['utm_campaign']), $new_url);
			} else {
			...
			if (isset($_GET['utm_term']) && $_GET['utm_term'] != '') {
				$new_url = str_replace("[[utm_term]]", urlencode((string)$_GET['utm_term']), $new_url);
			} else {
			...
			if (isset($_GET['utm_content']) && $_GET['utm_content'] != '') {
				$new_url = str_replace("[[utm_content]]", urlencode((string)$_GET['utm_content']), $new_url);
			} else {
