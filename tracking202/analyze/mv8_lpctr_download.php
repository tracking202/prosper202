...
header("Content-Disposition: attachment; filename=T202_tracking_mv8_".time().".xls");
header("Pragma: no-cache");
header("Expires: -1");
	
	
echo "Snippet H" . "\t" . "Clicks" . "\t" . "Click Throughs" . "\t" . "LP CTR" . "\t" . "Leads" . "\t" . "S/U"  . "\t" . "Payout"  . "\t" . "EPC"  . "\t" . "Avg CPC"  . "\t" . "Income"  . "\t" . "Cost"  . "\t" . "Net" . "\t" . "ROI"  . "\n";


while ($keyword_row = mysql_fetch_array($keyword_result, MYSQL_ASSOC)) { 
	
	if (!$keyword_row['mv8']) { 
		$keyword_row['mv8'] = '[Snippet H unused]';    
	} 

	echo 
	$keyword_row['mv8'] . "\t" . 
	$keyword_row['sort_mv8_clicks'] . "\t" .
	$keyword_row['sort_mv8_click_throughs'] . "\t" .
	$keyword_row['sort_mv8_ctr'] . "\t" .
	$keyword_row['sort_mv8_leads'] . "\t" .
	$keyword_row['sort_mv8_su_ratio'].'%' . "\t" .
	dollar_format($keyword_row['sort_mv8_payout']) . "\t" .
	dollar_format($keyword_row['sort_mv8_epc']) . "\t" .
	dollar_format($keyword_row['sort_mv8_cpc'], $cpv) . "\t" .
	dollar_format($keyword_row['sort_mv8_income']) . "\t" .
	dollar_format($keyword_row['sort_mv8_cost'], $cpv) . "\t" .
	dollar_format($keyword_row['sort_mv8_net'], $cpv) . "\t" .
	$keyword_row['sort_mv8_roi'].'%' . "\n";
