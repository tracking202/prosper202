...
<div id="area_<?php echo$count; ?>">
	<select name="aff_campaign_id_<?php echo$count; ?>" id="aff_campaign_id_<?php echo$count; ?>" onchange="">
	...
	<a class="onclick_color" onclick="remove_area(<?php echo$count; ?>);">[remove]</a>
</div>
