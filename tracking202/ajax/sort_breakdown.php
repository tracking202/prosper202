...
<table cellpadding="0" cellspacing="1" class="m-stats">
    <tr>
        <th><a class="onclick_color" onclick="loadContent('/tracking202/ajax/sort_breakdown.php', '', '<?php echo$html['sort_breakdown_order']; ?>');">Time</a></th>
    ...
    <tr>
            ...
            <td class="<?php
            if ($breakdown_row['sort_breakdown_net'] > 0) {
                echo 'm-row_pos';
            ...
            ?>"><?php echo$html['sort_breakdown_net']; ?></td>
            <td class="<?php
            if ($breakdown_row['sort_breakdown_net'] > 0) {
                echo 'm-row_pos';
            } elseif ($breakdown_row['sort_breakdown_net'] < 0) {
            ...
            ?>"><?php echo$html['sort_breakdown_roi']; ?></td>
        </tr>
<?php } error_reporting(0); ?>
        ...
        <tr>
            ...
            <td class=" m-row-bottom <?php
            if ($stats_total['net'] > 0) {
                echo 'm-row_pos';
            } elseif ($stats_total['net'] < 0) {
                echo 'm-row_neg';
            } else {
                echo 'm-row_zero';
            } ?>"><strong><?php echo$html['net']; ?></strong></td>
        <td class=" m-row-bottom <?php
        if ($stats_total['net'] > 0) {
            echo 'm-row_pos';
        } elseif ($stats_total['net'] < 0) {
            ...
            echo 'm-row_zero';
        } ?>"><strong><?php echo$html['roi']; ?></strong></td>
    </tr>
</table>
