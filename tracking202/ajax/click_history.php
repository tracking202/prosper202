...
";
	$db_table = "2c";
	$query = query($command, $db_table, true, true, true, '  ORDER BY 2c.click_id DESC ', $_POST['offset'] ?? 0, true, true);
}
		...
		<table class="table table-bordered" id="stats-table">
			...
			<tbody>
				...
				?><div style="text-align: center; font-size: 14px; border-bottom: 1px rgb(234,234,234) solid; padding: 10px;">You have no data to display with your above filters currently.</div><?php if (isset($_GET['spy']) && $_GET['spy'] == 1) {
					...
					<tr <?php if (($diff <= 5) and ($new == true)) {
																																																																																															echo 'class="new-click" style="display:none;"';
																																																																																														} ?>>
						...
						<td class="referer_big">
							<div style="text-overflow: ellipsis; overflow : hidden; white-space: nowrap; width: 150px;" title="<?php if ($html['referer']) echo $html['referer'];
																																																																																																		...
																																																																																																		printf('<a href="%s" target="_new" title="Referer">%s</a>', $html['referer'], $html['referer_host']); ?><?php  ?></div>
						</td>
