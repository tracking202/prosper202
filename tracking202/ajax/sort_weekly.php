...
/**
 * Overview › Week Parting: the report per day of the week, added up over the
 * window.
 *
 * Drawn into tracking202/overview/week-parting.php on the v2 shell; the
