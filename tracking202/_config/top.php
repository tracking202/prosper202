  ...
  <div id="nav-secondary" <?php if (($navigation[1] == 'forum') or ($navigation[1] == 'blog') or ($navigation[1] == 'misc') or ($navigation[1] == 'videos')) { echo ' class="core" '; } ?>>
	  <div>
		<?php if ($navigation[2] == 'setup') { $nav = true; ?>
			<ul>
				<li <?php if ($navigation[3] == 'ppc_accounts.php' or !$navigation[3]) { echo 'class="on"'; } ?>><a href="/tracking202/setup/ppc_accounts.php">#1 Traffic Sources</a></li>
				<li <?php if ($navigation[3] == 'aff_networks.php') { echo 'class="on"'; } ?>><a href="/tracking202/setup/aff_networks.php">#2 Categories</a></li>
				<li <?php if ($navigation[3] == 'aff_campaigns.php') { echo 'class="on"'; } ?>><a href="/tracking202/setup/aff_campaigns.php">#3 Campaigns</a></li>
		...
		<?php if ($navigation[2] == 'analyze') { $nav = true; ?>
			<ul>
				...
				<li <?php if ($navigation[3] == 'keywords_lpctr.php' or !$navigation[3]) { echo ' class="on" '; } ?>><a href="/tracking202/analyze/keywords_lpctr.php">Keywords LP CTR</a></li>
				<li <?php if ($navigation[3] == 'text_ads.php') { echo 'class="on"'; } ?>><a href="/tracking202/analyze/text_ads.php">Text Ads</a></li>
				<li <?php if ($navigation[3] == 'text_ads_lpctr.php' or !$navigation[3]) { echo ' class="on" '; } ?>><a href="/tracking202/analyze/text_ads_lpctr.php">Text Ads LP CTR</a></li>
				<li <?php if ($navigation[3] == 'referers.php') { echo 'class="on"'; } ?>><a href="/tracking202/analyze/referers.php">Referers</a></li>
				<li <?php if ($navigation[3] == 'referers_lpctr.php' or !$navigation[3]) { echo ' class="on" '; } ?>><a href="/tracking202/analyze/referers_lpctr.php">Referers LP CTR</a></li>
