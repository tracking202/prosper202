...
- **iOS SKAdNetwork (SKAN) Measurement** — Act as your iOS app's SKAN attribution endpoint: receive Apple's signed install postbacks, verify their signatures, decode conversion values into events and revenue, and report installs by ad network, campaign, and country ([guide](documentation/api/19-skan.md)).
