...
if (isset($_POST['maxmind'])) {
	...
	if ($_POST['maxmind'] == "true") {
		...
		if (file_exists($geo_dir . '/GeoIP2-ISP.mmdb') || file_exists($geo_dir . '/GeoIPISP.dat')) {
			...
			echo "ISP Database file doesn't exist. Upload GeoIP2-ISP.mmdb (or legacy GeoIPISP.dat) to "
				. htmlspecialchars(getenv('P202_GEO_DIR') ?: '/202-config/geo', ENT_QUOTES, 'UTF-8') . " folder.";
		}
	}
...
<div class="row account">
	<div class="col-xs-12">
		...
		<span class="infotext"><span><a href="http://click202.com/tracking202/redirect/dl.php?t202id=9159015&t202kw=p202setup" target="_blank"><img src="<?php echo get_absolute_url(); ?>202-img/maxmind_logo-202.png"></a></span><br>To turn on ISP/Carrier lookup feature, you need
			to <strong><a href="http://click202.com/tracking202/redirect/dl.php?t202id=9159015&t202kw=p202setup" target="_blank">buy MaxMind ISP database</a></strong> and upload (GeoIP2-ISP.mmdb or legacy GeoIPISP.dat) to <code><?php echo htmlspecialchars(getenv('P202_GEO_DIR') ?: getTrackingDomain() . get_absolute_url() . '202-config/geo/', ENT_QUOTES, 'UTF-8'); ?></code>
