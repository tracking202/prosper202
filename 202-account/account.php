    ...
    <table class="my-account-tables"  cellpadding="5" cellspacing="0">
        ...
        <tr>
            <td colspan="2">
                <?php if ($update_profile == true) { ?>
                    ...
                    <?php } ?>
                    <?php echo $error['token'] . $error['user_email'] . $error['user_keyword_searched_or_bidded'] . $error['user_tracking_domain']; ?>
            </td>
        </tr>
        <tr>
			...
			<select name="user_timezone">
                            <option <?php if ($html['user_timezone'] == '-11') {
                        echo 'selected=""';
                    } ?> value="-11">-1100 : Samoa</option>
                            <option <?php if ($html['user_timezone'] == '-10') {
                        echo 'selected=""';
                    } ?> value="-10">-1000 : Alaska, Hawai'i</option>
                            <option <?php if ($html['user_timezone'] == '-9') {
                        echo 'selected=""';
                    } ?> value="-9">-0900 : </option>
                            <option <?php if ($html['user_timezone'] == '-8') {
                        echo 'selected=""';
                    } ?>  value="-8">-0800 : US Pacific</option>
                            <option <?php if ($html['user_timezone'] == '-7') {
                        echo 'selected=""';
                    } ?> value="-7">-0700 : US Mountain</option>
                            <option <?php if ($html['user_timezone'] == '-6') {
                        echo 'selected=""';
                    } ?> value="-6">-0600 : US Central</option>
                            <option <?php if ($html['user_timezone'] == '-5') {
                        echo 'selected=""';
                    } ?> value="-5">-0500 : US Eastern</option>
                            <option <?php if ($html['user_timezone'] == '-4') {
                        echo 'selected=""';
                    } ?> value="-4">-0400 : Atlantic</option>
                            <option <?php if ($html['user_timezone'] == '-3.5') {
                        echo 'selected=""';
                    } ?> value="-3.5">-0350 : Newfoundland</option>
                            <option <?php if ($html['user_timezone'] == '-3') {
                            echo 'selected=""';
                        } ?> value="-3">-0300 : Brazil, Argentina</option>
                            <option <?php if ($html['user_timezone'] == '-2') {
                            echo 'selected=""';
                        } ?> value="-2">-0200 : Mid Atlantic</option>
                            <option <?php if ($html['user_timezone'] == '0') {
                            echo 'selected=""';
                        } ?> value="0">+0000 : London, Dublin</option>
                            <option <?php if ($html['user_timezone'] == '1') {
                            echo 'selected=""';
                            ...
                            <option <?php if ($html['user_timezone'] == '5.5') {
                            echo 'selected=""';
                        } ?> value="5.5">+0530 : India</option>
                            <option <?php if ($html['user_timezone'] == '7') {
                            echo 'selected=""';
                        } ?> value="7">+0700 : Bangkok</option>
                            <option <?php if ($html['user_timezone'] == '7.5') {
                            echo 'selected=""';
                        } ?> value="7">+0700 : </option>
                            <option <?php if ($html['user_timezone'] == '8') {
                            echo 'selected=""';
                            ...
                            <option <?php if ($html['user_timezone'] == '9.5') {
                            echo 'selected=""';
                            ...
                            <option <?php if ($html['user_timezone'] == '12') {
                            echo 'selected=""';
        ...
        <tr>
			...
			<td><select name="user_keyword_searched_or_bidded">
                                <option <?php if ($html['user_keyword_searched_or_bidded'] == 'searched') {
                    echo 'selected=""';
                } ?> value = "searched">Pickup Searched Keyword</option>
                                <option <?php if ($html['user_keyword_searched_or_bidded'] == 'bidded') {
                    echo 'selected=""';
		...
		<tr>
			<td class="left_caption">Email *</td>
                        <td><input type="text" name="user_email" size="40" value="<?php echo $html['user_email']; ?>"/></td>
                </tr>

		<tr>
			<td class="left_caption">Tracking Domain</td>
                        <td><input type="text" name="user_tracking_domain" size="40" value="<?php echo $html['user_tracking_domain']; ?>"/></td>
                </tr>
    ...
    <table class="my-account-tables" style="margin-top: 30px;" cellpadding="5" cellspacing="0">
        <tr>
            <td colspan="2">
				...
				<p class="first bold" >If you do not know your developer api key, you may get it <a href="http://developers.tracking202.com">here</a>.</p>
            </td>
		</tr>
        <tr>
            <td colspan="2">
        ...
        <tr>
			<td class="left_caption">My Tracking202 API Key</td>
                        <td><input type="text" name="user_api_key" size="40" value="<?php echo $html['user_api_key']; ?>"/></td>
        </tr>
        <tr>
            <td/>
			<td>
				<input class="submit" type="submit" value="Update API Keys"/>
                                <?php if ($_SESSION['user_api_key']) echo "&nbsp;&nbsp; <button class='submit' onclick='window.location=\"?remove_user_api_key=1\"; return false;'>Delete Api Key</a>"; ?>
                        </td>
		</tr>
    </table>
</form>
...
<form method="post" action="">
<table class="my-account-tables" style="margin-top: 30px; padding: 15px; background:#FFFBCC none repeat scroll 0; border:1px solid #E6DB55;" cellpadding="5" cellspacing="0">
    <input type="hidden" name="change_user_stats202_app_key" value="1" />
    <input type="hidden" name="token" value="<?php echo $_SESSION['token']; ?>" />
		<tr>
			<td colspan="2">
				<h2 class="green">Stats202 App Key</h2>
				<p class="first bold" >Enter your stats202 application key below to get access to the stats202 application. You can find this key by clicking <a href="http://developers.tracking202.com">here</a>. </p>
			</td>
		</tr>
        <tr>
            <td colspan="2">
        ...
        <tr>
			...
			<td>
                            <input type="text" name="user_stats202_app_key" size="40" value="<?php echo $html['user_stats202_app_key']; ?>"/>
                        </td>
        </tr>
        <tr>
            <td/>
			<td>
				<input class="submit" type="submit" value="Update App Key"/>
                                <?php if ($_SESSION['user_stats202_app_key']) echo "&nbsp;&nbsp; <button class='submit' onclick='window.location=\"?remove_user_stats202_app_key=1\"; return false;'>Delete App Key</a>"; ?>
                        </td>
		</tr>
    </table>
</form>
