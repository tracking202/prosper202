...
AUTH::require_user();
 ...
 foreach ($items as $item) {
 	...
 	if ($counter < 20) {?>
	 	<h4><a href="http://meetup.tracking202.com"><img src="/202-img/meetup_logo.png"/ class="news_icon"></a> <a href='<?php echo ($html['link']); ?>'><?php echo $html['title']; ?></a> - <?php echo $html['time']; ?></h4>
