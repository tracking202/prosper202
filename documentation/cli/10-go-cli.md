...
| `p202 app encoding list` | SKAN encodings (CRUD; `--registration-id` names an iOS registration, `0` the account-wide set; drives both reports and the runtime schema) |
