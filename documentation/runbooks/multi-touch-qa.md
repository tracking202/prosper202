...
2. Use the attribution API to flip toggles without direct SQL:
   ...
   - `POST /api/v3/attribution/models` to spin up test models; mark defaults via `is_default` in the payload.【F:documentation/api/13-attribution.md†L28-L37】
