...
Status: **in progress.** PR 0 (legacy endpoints), PR 1 (the conversion ledger), PR 1b (breakdown reads), PR 2 (identity capture), PR 3 (the app core reshape), PR 4 (the goals engine), PR 4b (web events), PR 8 (the iOS SDK), PR 9 (the MTA engine) and PR 10 (the MTA UI and exports) are built; the rest is proposal.
...
- **User deletion.** Today `202-account/user-management.php` deletes no
  ...
  **The audit (PR 3).** Before PR 3 there were three writers of
  ...
  Still to join the cascade: `202_app_installs` (PR 5). Each PR adds its
