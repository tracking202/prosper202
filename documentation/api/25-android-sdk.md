...
[24-android-installs.md](24-android-installs.md): the store link puts a
...
2. Make the campaign's offer URL the store link with the install token in
   ...
   ([24-android-installs.md §1](24-android-installs.md#1-the-store-link)):
...
`require`, [24-android-installs.md §9](24-android-installs.md#9-play-integrity)),
