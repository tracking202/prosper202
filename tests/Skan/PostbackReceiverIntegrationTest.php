...
use Prosper202\Database\Tables\SkanTables;
...
final class PostbackReceiverIntegrationTest extends TestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        foreach (SkanTables::getDefinitions() as $definition) {
    ...
    protected function setUp(): void
    {
        ...
        self::$db->query('TRUNCATE TABLE 202_skan_postbacks');
        self::$db->query('TRUNCATE TABLE 202_skan_apps');
    }
    ...
    {
        self::$db->query(
            "INSERT INTO 202_skan_apps (user_id, app_id, app_name, schema_token, created_at, updated_at)
        ...
        $result = self::$db->query('SELECT app_id, user_id FROM 202_skan_postbacks ORDER BY postback_id');
        $rows = array_map(
    ...
    {
        $result = self::$db->query('SELECT COUNT(*) AS c FROM 202_skan_postbacks');
