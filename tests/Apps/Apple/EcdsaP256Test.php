...
use Api\V3\Apps\Apple\EcdsaP256;
use Tests\TestCase;
...
final class EcdsaP256Test extends TestCase
{
    ...
    private function probeScript(string $classFile, string $resultPath): string
    {
        ...
        \$result = [
            ...
            'genuine_signature' => \\Api\\V3\\Apps\\Apple\\EcdsaP256::verify(\$message, \$signature, \$public_key_b64),
            'wrong_signature' => \\Api\\V3\\Apps\\Apple\\EcdsaP256::verify('tampered ' . \$message, \$signature, \$public_key_b64),
            'absent_signature' => \\Api\\V3\\Apps\\Apple\\EcdsaP256::verify(\$message, null, \$public_key_b64),
            'broken_key' => \\Api\\V3\\Apps\\Apple\\EcdsaP256::verify(\$message, \$signature, 'not-a-key'),
        ];
