...
eq "$(field "[c['resource'] + ':' + c['action'].split(' ')[0] for c in d['data']['cascade'] if c['resource'].startswith(('202_app_', '202_api_'))]")" \
   '["202_api_keys:delete", "202_app_postbacks:release", "202_app_skan_encodings:delete", "202_app_installs:delete", "202_app_integrity_credentials:delete", "202_app_registrations:delete"]' \
